...
def get_list(request):
    ...
    if page.has_previous():
        output["prev_url"] = (
            reverse("imagepool_index") + "?page=" + str(page.previous_page_number())
        )
    else:
        output["prev_url"] = ""
    ...
    if page.has_next():
        output["next_url"] = (
            reverse("imagepool_index") + "?page=" + str(page.next_page_number())
        )
    else:
        output["next_url"] = ""
...
def upload_file(request):
    if request.method == "POST" and request.FILES["files_to_upload"]:
